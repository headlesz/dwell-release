<p align="center">
  <img src="docs/rosette-field.png?v=1.08" width="760" alt="Thirty-two rosettes in a grid, eight list colours across, every one visibly different from the rest">
</p>
...
<p align="center">
  <img src="docs/rosettes.png?v=1.08" width="840" alt="Twelve rosettes in a row, each five dots, all visibly different from one another">
</p>
...
<p align="center">
  <img src="docs/pills.png?v=1.08" width="430" alt="Seven pills, each showing a task title beside its own five-dot flower">
</p>
...
<p align="center">
  <img src="docs/orbit.png?v=1.08" width="760" alt="Nine frames across one revolution, the petals holding formation as they circle the centre">
</p>
...
<p align="center">
  <img src="docs/picker.png?v=1.08" width="430" alt="The what's next picker: three list sections, each row showing a reminder's flower beside its title and due date">
  <img src="docs/detail.png?v=1.08" width="430" alt="The detail panel: a flower beside the task title, then list, due and priority as labelled fields">
</p>
...
<p align="center">
  <img src="docs/search.png?v=1.08" width="430" alt="The picker in search mode, the header replaced by a query field, matching rows, and hints reading return done and esc clear">
  <img src="docs/compose.png?v=1.08" width="430" alt="The compose panel: a title field, a when field reading friday 3pm, the parsed date echoed beneath, and a target list">
</p>
...
<p align="center">
  <img src="docs/filter-joined.png?v=1.08" width="430" alt="The picker filtering on 'tdy & tmrw', showing today's, overdue and tomorrow's reminders, with the parse echoed as 'today & tomorrow'">
</p>
...
<p align="center">
  <img src="docs/filter-not.png?v=1.08" width="430" alt="The picker filtering on 'tdy not late', showing today's two reminders with the overdue ones removed, echoed as 'today not overdue'">
</p>
...
<p align="center">
  <img src="docs/filter.png?v=1.08" width="430" alt="The picker filtering on 'work tdy', showing two work items due today, with the parse echoed as 'work · today'">
</p>
...
<p align="center">
  <img src="docs/queue.png?v=1.08" width="430" alt="The compose panel with shift held: the add button replaced by a green queue button">
</p>
...
<p align="center">
  <img src="docs/encouragement.png?v=1.08" width="520" alt="A pill reading 'look at you go' with a colour gradient flowing through the letters">
</p>
...
<p align="center">
  <img src="docs/term.png?v=1.08" width="430" alt="The detail panel with shift held: the done button replaced by a red term button">
</p>
...
<p align="center">
  <img src="docs/presentation.png?v=1.08" width="720" alt="The fullscreen view: one large rosette above the task title and the current time, centred on black">
</p>
...
<p align="center">
  <img src="docs/settings.png?v=1.08" width="430" alt="The settings window: a sidebar listing settings and about, with two rebindable shortcut rows, desktop and startup controls">
  <img src="docs/about.png?v=1.08" width="430" alt="The about pane: a large rosette, the name, version, author and links">
</p>
...
<p align="center">
  <img src="docs/marquee.png?v=1.08" width="560" alt="A pill at its maximum width, the title cut off with a soft fade on the right before the anchor dot">
</p>
